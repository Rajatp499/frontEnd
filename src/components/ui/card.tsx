...
export default function FeatureCard({ 
  ...
  return (
    <div 
      className={`bg-background py-6 md:py-8 px-6 md:px-12 rounded-md hover:shadow-xl hover:scale-105 cursor-pointer transition-all duration-300 ${
...
const FeatureTextCard=({icon:Icon, title, text, color, index}: FeatureTextCardProps)=>{
  // console.log(Icon)
  return(
    <motion.div
                  key={index}
                ...
                >
                  <div className={`w-14 h-14 bg-linear-to-br ${color} rounded-xl flex items-center justify-center mb-4`}>
